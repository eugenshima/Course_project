...
public class StaffingWindowHRController {
    ...
    void initialize() {
        ...
        StaffingManagmentButton.setOnAction(ActionEvent -> {
            StaffingManagmentButton.getScene().getWindow().hide();
            FXMLLoader fxmlLoader = new FXMLLoader();
            fxmlLoader.setLocation(getClass().getResource("StaffingManagmentMenu.fxml"));
            try {
                fxmlLoader.load();
            } catch (IOException e) {
                throw new RuntimeException(e);
